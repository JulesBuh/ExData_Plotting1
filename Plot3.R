...
#>1 Function Body----
      ...
      #1.2 creates the linegraph----
            graphics::plot (x=c(dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                                dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                                dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax]),
                            y=c(dataRead$Sub_metering_1[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                                dataRead$Sub_metering_1[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax], 
                                dataRead$Sub_metering_3[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax]),
                            type="n",
                            col="black",
            ...
            graphics::lines (x=dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            y=dataRead$Sub_metering_1[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            type="l")
            graphics::par(col=lineCol[2])
            graphics::lines(x=dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            y=dataRead$Sub_metering_2[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            type="l")
            graphics::par(col=lineCol[3])
            graphics::lines (x=dataRead$Time[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            y=dataRead$Sub_metering_3[dataRead$Date>=studyPeriodMin&dataRead$Date<=studyPeriodMax],
                            type="l")
